...
#define QMM_WRITEJASSLOG	(g_pluginfuncs->pfnWriteQMMLog)
...
#define QMM_GETLOGHANDLE	(g_pluginfuncs->pfnGetGetLogHandle)
#define QMM_GETHOMEPATH		(g_pluginfuncs->pfnHomePath)
#define QMM_GETPLUGINID		(g_pluginfuncs->pfnGetPluginID)
#define QMM_GETPLUGININFO	(g_pluginfuncs->pfnGetPluginInfo)
#define QMM_PLUGINCALL		(g_pluginfuncs->pfnPluginCall)
...
C_DLLEXPORT int		QMM_Attach(eng_syscall_t engfunc, mod_vmMain_t modfunc, pluginres_t* presult, pluginfuncs_t* pluginfuncs, int iscmd);
...
C_DLLEXPORT int		QMM_pluginCall(int cmd, int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9, int arg10, int arg11, int arg12);
